...
---
### Reading: Accessibility considerations for color
...
- If you want to learn more about designing with accessible colors, check out this video from the W3C, the creators of the WCAG guidelines, that demonstrates how to review designs for web accessibility: Easy Checks: A First Review of Website Accessibility.
...
### Reading: Learn about more visual design elements
...
### Reading: Use negative space in mockups 
...
Why is it so important to consider negative space when you create mockups? Check out these three reasons.
